...
// The links from your document have been added to the project data.
// It's a good practice to include these directly with the project object.
const projects = [
    // --- AI Projects ---
    {
        id: 1,
        ...
        githubLink: "https://github.com/chakri30/Distress-Detection",
    },
    {
        id: 2,
        ...
        githubLink: "https://github.com/chakri30/Plastic-Classification",
    },
    {
        id: 3,
        ...
        githubLink: "https://github.com/chakri30/twitter-senttiment-analysis",
    },
    ...
    // --- Web/Full-Stack Projects ---
    {
        ...
        githubLink: "https://github.com/chakri30/Farm-Tech",
    },
    {
        id: 5,
        ...
        githubLink: "https://github.com/chakri30/School-Management-System-",
    },
    ...
    // --- Frontend Projects ---
    {
        ...
        githubLink: "https://github.com/chakri30/Green-Cycle-Hub",
    },
    ...
    // --- Analytics/Data Projects ---
    {
        ...
        githubLink: "https://github.com/chakri30/NIFTY-BANK-Stock-Analysis-Dashboard",
    },
];
                    ...
                    {filteredProjects.map((project) => (
                        ...
                        >
                            ...
                            <CardContent className="relative z-10">
                                ...
                                {/* The new links have been added here, using the data from the 'projects' array */}
                                <div className="flex gap-4 mt-6">
                                    {project.githubLink && (
                                        <Button
                                            asChild
                                            variant="outline"
                                            className="bg-transparent text-ice-white hover:bg-slate-gray/20 border-slate-gray/50 transition-colors"
                                        >
                                    ...
                                    {/* Add other links if available, e.g., a live demo link */}
                                    {/*
